...
const services = [
  ...
  },
  {
    ...
    icon: <Hotel />,
    linkText:
      "Olá! Vi a seção de Hotel para pets e gostaria de mais informações.",
  },
];
                ...
                >
                  <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                    ...
                    <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                      ...
                      <a
                        target="_blank"
                        href={`https://wa.me/5531971899236?text=Olá vim pelo site e gostaria de mais informações sobre ${item.title}`}
